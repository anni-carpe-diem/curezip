        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-24 items-center">
          ...
          >
            ...
            <div className="space-y-4 text-base md:text-lg text-gray-600 leading-relaxed">
              <p>
                We are dedicated to fulfilling the promise of human potential—in every place and at every stage of life. We believe health is the key to that promise.
              </p>
              <p>
                At our healthiest, we can achieve anything. That is why our pursuit of helping people achieve their best health at every stage of life will never end.
              </p>
            </div>
