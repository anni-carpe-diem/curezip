...
function TeamCard({ member }) {
  return (
    <motion.div
      variants={fadeIn}
      className="group relative flex-shrink-0 w-[160px] lg:w-[210px] rounded-2xl overflow-hidden bg-white shadow-sm hover:shadow-xl transition-all duration-300"
    >
      {/* Photo */}
  ...
  return (
    <AnimatedSection className="py-20 md:py-24 bg-[#f7fafd]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          className="flex gap-4 lg:gap-5 items-start justify-center flex-nowrap"
